...
<div x-data="{
    ...
    <div x-show="show"
        class="mb-6 bg-white dark:bg-zinc-900 rounded-lg  shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
        ...
        <div class="space-y-2">
            ...
            <div aria-hidden="true" class="px-2 border-t border-gray-300 dark:border-zinc-800"></div>
        </div>
        <div>
            {{ $slot }}
        </div>
