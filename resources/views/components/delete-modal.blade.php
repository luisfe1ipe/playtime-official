...
<div x-data="{
    ...
    <div x-cloak x-show="show"
        class="mb-6 bg-white dark:bg-zinc-900 text-gray-100 rounded-lg  shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
        ...
        <div class="relative rounded-lg shadow">
            <form wire:submit.prevent='{{ $function }}'>
                <button type="button" x-on:click="$dispatch('close')"
                    class="absolute top-3 right-2.5 text-gray-400 bg-transparent rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center transition-colors ease-linear hover:bg-gray-100 hover:text-gray-500 dark:hover:bg-zinc-700 dark:hover:text-white"
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-lg font-normal text-gray-700 dark:text-gray-300">
                        {{ $text }}
                    </h3>
                    @if ($subtext != null)
