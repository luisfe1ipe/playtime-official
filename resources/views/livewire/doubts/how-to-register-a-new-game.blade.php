    ...
    <x-container>
        <div class="flex flex-col gap-12 py-12 md:flex-row">
            <div class="w-full md:w-1/2">
                <h4>Onde a foto do campo <span class="text-primary-500">imagem</span> será usado ?</h4>
                <p>O campo <span class="text-primary-700">imagem</span> será a logo do jogo. Por exemplo:</p>
            ...
            <div class="w-full md:w-1/2">
                <h4>Onde a foto do campo <span class="text-primary-500">imagem alternativa</span> será usada ?</h4>
                <p>O campo <span class="text-primary-500">imagem alternativa</span> será utilizado na hora de selecionar
                    o jogo no qual o
