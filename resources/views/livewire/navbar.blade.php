<nav x-data="" class="sticky top-0 z-30 w-full bg-white border-b border-gray-300 dark:border-zinc-800 dark:bg-zinc-900">
    <x-container>
        <div class="flex items-center justify-between w-full h-20">
            ...
            <div>
                ...
                <livewire:navbar.notification>
                    @endauth
                    @guest
                    <a class="focus:outline-none focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-white bg-purple-600 hover:bg-purple-700 focus:ring-purple-900"
